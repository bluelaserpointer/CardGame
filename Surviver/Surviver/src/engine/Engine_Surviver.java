...
public class Engine_Surviver extends Game {
	...
	public Engine_Surviver() {
		super(null);
	}
	//gui
	private static GUIParts titleScreen, menuScreen, lotteScreen, garrageScreen, formationScreen, enemyScreen, battleScreen;
	private static Stack<GUIParts> screenHistory = new Stack<GUIParts>();
	//menuScreen
	private static GUIParts resourcesButtons;
	...
	public static void main(String args[]) {
		new GHQ(new Engine_Surviver(), 1000, 600);
	}
	...
	public void loadResource() {
		...
		GHQ.addGUIParts(titleScreen = new GUIParts() {
			...
			public void idle() {
				...
				GHQ.drawStringGHQ("Presented by \"幸存者\"", GHQ.screenW() - 250, GHQ.screenH() - 50, 20f);
				super.idle();
			}*/
		});
			...
			protected void paintOfCell(int id, HasDotPaint object, int x, int y) {
				...
				if(object != null) {
					...
					if(formationTS.contains(object)) {
						...
						GHQ.drawStringGHQ("已编队", x + 10, y + 85, GHQ.getG2D().getFont().deriveFont(Font.BOLD, 15f));
					}
				}
			}
			@Override
