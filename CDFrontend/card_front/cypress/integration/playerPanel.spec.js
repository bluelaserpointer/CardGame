...
context('UserPanel', () => {
  ...
  it('User Panel OwnItem Update Data', () => {
    cy.get(':nth-child(1) > .el-table_2_column_17 > .cell > .link-type').click()
  ...
  it('User Panel OwnCard Update Data', () => {
    cy.get(':nth-child(1) > .el-table_3_column_22 > .cell > .link-type').click()
  ...
  it('User Panel OwnCard Delete Data', () => {
    ...
    cy.wait(500)
    cy.get('.deleteOwnCardInnerButton > span').click({ multiple: true, force: true })
    cy.wait(500)
