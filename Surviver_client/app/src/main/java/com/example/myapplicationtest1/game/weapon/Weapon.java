package com.example.myapplicationtest1.game.weapon;
...
public class Weapon {
	...
	public Weapon() {
		...
		reloadSpeed = 1;
		magazineSize = Integer.MAX_VALUE;
	...
	public void reset() {
		...
		if(magazineSize != Integer.MAX_VALUE)
			magazine = 0;
	}
	///////////////////
	//idle
	 ...
	 * By default, it always returns {@link Integer#MAX_VALUE}<br>
	...
	public final int getMagazineEmptySpace() {
		return magazineSize != Integer.MAX_VALUE ? magazineSize - magazine : Integer.MAX_VALUE;
	}
