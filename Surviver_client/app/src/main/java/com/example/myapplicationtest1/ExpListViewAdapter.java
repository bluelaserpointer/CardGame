...
public class ExpListViewAdapter extends RecyclerView.Adapter<ExpListViewAdapter.ViewHolder>{
    ...
    public ExpListViewAdapter(Context mContext, ArrayList<String> mTexts, ArrayList<String> mImages) {
        this.mTexts = mTexts;
