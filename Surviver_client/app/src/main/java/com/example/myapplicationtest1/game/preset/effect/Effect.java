package com.example.myapplicationtest1.game.preset.effect;
...
public class Effect extends GHQObject implements HasPoint, HasDotPaint {
	...
	public Effect() {
		physics().setPoint(new DstCntDynam());
	...
	public boolean isOutOfRange() {
		return limitRange != Integer.MAX_VALUE && limitRange <= ((DstCntDynam)point()).getMovedDistance();
	}
