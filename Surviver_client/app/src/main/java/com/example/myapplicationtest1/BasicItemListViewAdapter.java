...
public class BasicItemListViewAdapter extends RecyclerView.Adapter<BasicItemListViewAdapter.ViewHolder>{
    ...
    public BasicItemListViewAdapter(Context mContext, ArrayList<String> mTexts, ArrayList<String> mImages) {
        this.mTexts = mTexts;
