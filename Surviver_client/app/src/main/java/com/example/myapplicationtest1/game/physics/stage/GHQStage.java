...
import com.example.myapplicationtest1.game.core.GHQObjectList;
import com.example.myapplicationtest1.game.core.GHQObjectType;
...
public class GHQStage implements HasBoundingBox {
	...
	public void draw(Paint paint) {
		GHQ.fillRect(0, 0, width(), height(), paint);
	}
