...
public class ItemControllerTest {
        ...
        public void findItemByItemId() throws Exception {
                ...
                MvcResult result = mockMvc.perform(get("/item/getItem?itemId=" + Item.getItemId())
        ...
        public void deleteItems() throws Exception {
                String token = getTOKEN();
                Item Item = addItemBeforeTest(token);
                MvcResult result = mockMvc.perform(get("/item/deleteItems?itemIds=" + Item.getItemId())
                                .contentType(MediaType.APPLICATION_JSON_VALUE).header("Authorization", token))
                                .andExpect(MockMvcResultMatchers.status().isOk()).andDo(MockMvcResultHandlers.print())
                                .andReturn();
                System.out.println(result.getResponse().getContentAsString());
        ...
        public void deleteItem() throws Exception {
                String token = getTOKEN();
                Item Item = addItemBeforeTest(token);
                MvcResult result = mockMvc.perform(get("/item/deleteItem?itemId=" + Item.getItemId())
                                .contentType(MediaType.APPLICATION_JSON_VALUE).header("Authorization", token))
                                .andExpect(MockMvcResultMatchers.status().isOk()).andDo(MockMvcResultHandlers.print())
                                .andReturn();
                System.out.println(result.getResponse().getContentAsString());
        ...
        public void ListPage() throws Exception {
                ...
                System.out.println(body);
                MvcResult result = mockMvc.perform(MockMvcRequestBuilders.post("/item/List").content(body)
                                .contentType(MediaType.APPLICATION_JSON_VALUE).header("Authorization", token))
                                .andExpect(MockMvcResultMatchers.status().isOk()).andDo(MockMvcResultHandlers.print())
                                .andReturn();
                System.out.println(result.getResponse().getContentAsString());
