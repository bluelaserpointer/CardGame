...
public class OwnItemControllerTest {
    ...
    public void findOwnItemByOwnItemId() throws Exception {
        MvcResult result = mockMvc
                .perform(get("/ownItem/getOwnItem?ownItemId=92").contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getAllOwnItems() throws Exception {
        MvcResult result = mockMvc.perform(get("/ownItem/getAllOwnItems").contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(MockMvcResultMatchers.status().isOk()).andDo(MockMvcResultHandlers.print()).andReturn();
        System.out.println(result.getResponse().getContentAsString());
    }
    ...
    public void deleteOwnItems() throws Exception {
        MvcResult result = mockMvc
                .perform(get("/ownItem/deleteOwnItems?ownItemIds=92").contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(MockMvcResultMatchers.status().isOk()).andDo(MockMvcResultHandlers.print()).andReturn();
        System.out.println(result.getResponse().getContentAsString());
    }
    ...
    public void deleteOwnItem() throws Exception {
        MvcResult result = mockMvc
                .perform(
                        get("/ownItem/deleteOwnItem?userId=12&itemId=10").contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(MockMvcResultMatchers.status().isOk()).andDo(MockMvcResultHandlers.print()).andReturn();
        System.out.println(result.getResponse().getContentAsString());
    }
