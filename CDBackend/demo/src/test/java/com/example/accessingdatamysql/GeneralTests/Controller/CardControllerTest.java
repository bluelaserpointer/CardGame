...
public class CardControllerTest {
    ...
    public void findCardByCardId() throws Exception {
        ...
        MvcResult result = mockMvc
                .perform(get("/card/getCard?cardId=" + addedCard.getCardId())
    ...
    public void updateCard() throws Exception {
        ...
        String body = JSON.toJSONString(card);
        MvcResult result = mockMvc
                .perform(get("/card/updateCard").contentType(MediaType.APPLICATION_JSON_VALUE).content(body)
                        .header("Authorization", token))
                .andExpect(MockMvcResultMatchers.status().isOk()).andDo(MockMvcResultHandlers.print()).andReturn();
        System.out.println(result.getResponse().getContentAsString());
    }
    ...
    public void getAllCards() throws Exception {
        String token = getTOKEN();
        MvcResult result = mockMvc
                .perform(get("/card/getAllCards").contentType(MediaType.APPLICATION_JSON_VALUE).header("Authorization",
                        token))
                .andExpect(MockMvcResultMatchers.status().isOk()).andDo(MockMvcResultHandlers.print()).andReturn();
        System.out.println(result.getResponse().getContentAsString());
    }
    ...
    public void deleteCards() throws Exception {
        ...
        Card addedCard = addCardBeforeTest();
        MvcResult result = mockMvc
                .perform(get("/card/deleteCards?cardIds=" + addedCard.getCardId())
                        .contentType(MediaType.APPLICATION_JSON_VALUE).header("Authorization", token))
                .andExpect(MockMvcResultMatchers.status().isOk()).andDo(MockMvcResultHandlers.print()).andReturn();
        System.out.println(result.getResponse().getContentAsString());
    }
    ...
    public void deleteCard() throws Exception {
        ...
        Card addedCard = addCardBeforeTest();
        MvcResult result = mockMvc
                .perform(get("/card/deleteCard?cardId=" + addedCard.getCardId())
                        .contentType(MediaType.APPLICATION_JSON_VALUE).header("Authorization", token))
                .andExpect(MockMvcResultMatchers.status().isOk()).andDo(MockMvcResultHandlers.print()).andReturn();
        System.out.println(result.getResponse().getContentAsString());
    }
