...
//    }
    ...
    public List<Chapter> updateChapter(@RequestParam("chapterId") Integer chapterId, @RequestParam("phaseNo") Integer phaseNo, @RequestParam("phaseType") Integer phaseType)
    {
        return chapterService.updateChapter(chapterId, phaseNo, phaseType);
    }

    @RequestMapping(value = "/addChapter")
    public List<Chapter> addChapter(@RequestParam("phaseNo") Integer phaseNo, @RequestParam("phaseType") Integer phaseType)
    {
